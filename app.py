...
def generate():
    ...
    Provide a subtitle for the passage. It should be a more specific overview of the passage than the title. It should be no more than 50 characters in length. It should be created with the following format: "subtitle": <subtitle>, where <subtitle> is to be replaced with the generated subtitle.
